...
export class DatabaseService {
    ...
    async createPost({ title, slug, contents, featuredImages, status, userId }) {
        try {
            console.log({ title, slug, contents, featuredImages, status, userId });
    ...
    async updatePost({ title, slug, contents, featuredImages, status }) {
        try {
